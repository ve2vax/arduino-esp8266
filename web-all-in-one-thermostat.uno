// Normand Labossiere VE2VAX / VA2NQ Nov-2018  version ds18b20 Version 1.4.6 Incluant les sondes bmp280,bme280
...
const char *ssid_ap = "ve2vax-iot-19" ;  //Change the ssid for every devices you program
...
void thermostat_cool() {
  ...
  {
    //turn on the cooling
    if ((temp_set >= 1) && ((t-0.2) > temp_set)) { relai_off(); } 
  }
}
